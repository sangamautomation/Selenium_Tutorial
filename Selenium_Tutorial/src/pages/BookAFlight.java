...
public class BookAFlight {
	...
	public void bookFlight_CreditCard(WebDriver driver){
		...
		sd.setText(driver, PO_BookAFlight.TEXTBOX_CREDITCARD ,h.get("CreditcardNo") );//"1234567890123456" - NoSuchElement exception
		...
		sd.setText(driver, PO_BookAFlight.TEXTBOX_CREDITCARD_FN, h.get("FirstName"));
		//driver.findElement(By.xpath("//input[contains(@name,'cc_frst_name')]")).sendKeys("John");
		
		sd.setText(driver,PO_BookAFlight.TEXTBOX_CREDITCARD_LN , h.get("LastName"));
		...
		sd.clickLink(driver, PO_BookAFlight.LINK_BUYFLIGHT);
