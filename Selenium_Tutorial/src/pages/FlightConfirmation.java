...
import pageObjects.PO_FlightConfirmation;
...
public class FlightConfirmation {
	...
	public void confirmation(WebDriver driver){
		...
		String confirmationMessage_Actual = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_CONFIRMATIONMSG);
		...
		String toPrice = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_TOPRICE);
		...
		String fromPrice = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_FROMPRICE);
		...
		String noPassengers = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_NOOFPASSENGERS);
		...
		String Totaltaxes = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_TAXES);
		...
		String totalPrice = sd.getWidgetText(driver, PO_FlightConfirmation.TEXT_TOTALPRICE	);
